  ...
  return {
    ...
    async artikelSkapa({ titel, html, sammanfattning, taggar, blogg_id, publicera, forfattare, seo_titel, seo_beskrivning }) {
      ...
      const m = await client.graphql(
        ...
        { article: { blogId: blogGid, title: titel, body: html, summary: sammanfattning || undefined, tags: taggar || undefined, isPublished: publicera === true, author: { name: forfattare || 'Martina Dagborn' } } });
